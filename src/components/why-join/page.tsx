          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700">No random strangers here—just an exclusive squad of handpicked, awesome humans who get you.</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Goodbye, Small Talk</h3>
                <p className="text-gray-700">Our experiences are designed to spark real conversations and genuine laughs.</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Quality Over Quantity</h3>
                <p className="text-gray-700">This isn&apos;t about meeting everyone—it&apos;s about finding your people.</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-2">Unforgettable Experiences</h3>
                <p className="text-gray-700">Life&apos;s too short for boring weekends and stale friendships. With M.E.T., you&apos;ll connect with amazing individuals and share unforgettable experiences.</p>
              </CardContent>
            </Card>
          </div>
        </section>
